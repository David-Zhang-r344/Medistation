...
public class AnalysisFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        symptomSeverityList = new ArrayList<>(30);
        symptomDateList = new ArrayList<>(30);
    ...
    public void setupDropDownMenu(View view) {
        ...
        generateGraph.setOnClickListener(v -> {
            ...
            if (!ItemSelected.equals("Patient Info")) {
                switch (ItemSelected) {
                    case "Heart Rate":
                        createHeartRateData();
                        whichData[0]= true;
            ...
            for (int i = 0; i < Objects.requireNonNull(allSleepQuality).size(); i++) {
                ...
                if (startTimes.get(0) < currentUpperBound && startTimes.get(0) > currentLowerBound){
                    ...
                    for (int k = 0; k < sleepDuration.size(); k++) {
                        assert dailySleepQualityValueList != null;
    ...
    public void findCurrentTime(View view) {
        DatePicker graphStartDatePicker = view.findViewById(R.id.graphStartDate);
